...
def insert_sample_data() -> None:
    ...
    locations = [
        {
            "location_id": 1,
            "name": "MIT Academic Block 5",
            "category_id": 1,
            "address": "MIT Campus Road, Manipal",
            "description": "Main lecture halls and faculty rooms.",
            "latitude": 13.3526,
            "longitude": 74.7928,
        },
        {
            "location_id": 2,
            "name": "MIT Central Library",
            "category_id": 1,
            "address": "MIT Campus Road, Manipal",
            "description": "Silent study area with digital resources.",
            "latitude": 13.3523,
            "longitude": 74.7936,
        },
        {
            "location_id": 3,
            "name": "Student Plaza Food Court",
            "category_id": 6,
            "address": "Student Plaza, Manipal",
            "description": "Popular food court with multiple counters.",
            "latitude": 13.3515,
            "longitude": 74.7921,
        },
        {
            ...
            "name": "NLH Hostel",
            "category_id": 3,
            "address": "Near MIT Main Gate, Manipal",
            "description": "Boys hostel with mess and common rooms.",
            "latitude": 13.3494,
            "longitude": 74.7932,
        },
        {
            "location_id": 5,
            "name": "KMC Greens Playground",
            "category_id": 4,
            "address": "KMC Greens, Manipal",
            "description": "Open ground used for football and events.",
            "latitude": 13.3488,
            "longitude": 74.7897,
        },
        {
            ...
            "description": "Major teaching hospital and emergency center.",
            "latitude": 13.3467,
            "longitude": 74.7929,
        },
        {
            "location_id": 7,
            "name": "Cafe Coffee Day Manipal",
            "category_id": 2,
            "address": "End Point Road, Manipal",
            "description": "Casual cafe for snacks and coffee.",
            "latitude": 13.3459,
            "longitude": 74.7869,
        },
        {
            ...
            "category_id": 4,
            "address": "Inside MAHE Campus, Manipal",
            "description": "Indoor stadium, gym and swimming pool.",
            "latitude": 13.3537,
            "longitude": 74.7883,
        },
        {
            ...
            "name": "FC1 Food Court",
            "category_id": 6,
            "address": "Near MIT Hostels, Manipal",
            "description": "Affordable food options for students.",
            "latitude": 13.3501,
            "longitude": 74.7941,
        },
        {
            "location_id": 10,
            "name": "MIT Innovation Center",
            "category_id": 1,
            "address": "Academic Zone, MIT Manipal",
            "description": "Startup and project incubation space.",
            "latitude": 13.3531,
            "longitude": 74.7914,
        },
    ]
    ...
    _bulk_insert(
        "Reviews",
        ["review_id", "user_id", "location_id", "rating", "comment", "date"],
        reviews,
    )
